...
sequence_commands_st sequence_1_A[] = {
    {TEXT_1_A1, 0,    3000, 50, 252},
    {TEXT_1_A2, 2000, 4000, 50, 252},
    {TEXT_1_A3, 3000, 6000, 50, 252},
    {TEXT_1_A4, 5000, 7000, 50, 252},
    {TEXT_1_A5, 6000, 9000, 50, 252},
};
uint16_t sequence_1_A_size = sizeof(sequence_1_A) / sizeof(sequence_1_A[0]);

sequence_commands_st sequence_1_B[] = {
    {TEXT_1_B1, 0,    500,  50, 252},
    {TEXT_1_B1, 1000, 1500, 50, 252},
    {TEXT_1_B1, 2000, 3000, 50, 252},
    {TEXT_1_B2, 1500, 2000, 50, 252},
    {TEXT_1_B2, 2500, 3500, 50, 252},
    {TEXT_1_B3, 3000, 3500, 50, 252},
    {TEXT_1_B3, 4000, 4500, 50, 252},
    {TEXT_1_B3, 5000, 6000, 50, 252},
    {TEXT_1_B4, 4500, 5000, 50, 252},
    {TEXT_1_B4, 5500, 6500, 50, 252},
    {TEXT_1_B5, 6000, 6500, 50, 252},
    {TEXT_1_B5, 7000, 7500, 50, 252},
    {TEXT_1_B6, 6500, 7000, 50, 252},
    {TEXT_1_B6, 7500, 8500, 50, 252},
    {TEXT_1_B5, 8000, 9000, 50, 252},
};
uint16_t sequence_1_B_size = sizeof(sequence_1_B) / sizeof(sequence_1_B[0]);

sequence_commands_st sequence_1_C[] = {
    {TEXT_1_C1, 0,    2000, 50, 252},
    {TEXT_1_C2, 1000, 3000, 50, 252},
    {TEXT_1_C3, 2000, 4000, 50, 252},
    {TEXT_1_C4, 3000, 5000, 50, 252},
    {TEXT_1_C5, 4000, 6000, 50, 252},
    {TEXT_1_C1, 7000, 9000, 50, 252},
    {TEXT_1_C2, 8000, 10000, 50, 252},
    {TEXT_1_C3, 9000, 11000, 50, 252},
    {TEXT_1_C4, 10000, 12000, 50, 252},
    {TEXT_1_C5, 11000, 13000, 50, 252},
};
uint16_t sequence_1_C_size = sizeof(sequence_1_C) / sizeof(sequence_1_C[0]);

sequence_commands_st sequence_1_D[] = {
    {TEXT_1_D1, 0,    2000, 50, 252},
    {TEXT_1_D2, 1000, 4000, 50, 252},
    {TEXT_1_D3, 3000, 5000, 50, 252},
    {TEXT_1_D4, 4000, 6000, 50, 252},
    {TEXT_1_D5, 5000, 8000, 50, 252},
    {TEXT_1_D6, 7000, 9000, 50, 252},
    {TEXT_1_D7, 8000, 10000, 50, 252},
    {TEXT_1_D8, 9000, 11000, 50, 252},
};
uint16_t sequence_1_D_size = sizeof(sequence_1_D) / sizeof(sequence_1_D[0]);

sequence_commands_st sequence_1_P[] = {
    {TEXT_1_P1, 0,    250,  50, 252},
    {TEXT_1_P2, 250,  500,  50, 252},
    {TEXT_1_P1, 500,  750,  50, 252},
    {TEXT_1_P2, 750,  1000, 50, 252},

    {TEXT_1_P1, 1000, 1250, 50, 252},
    {TEXT_1_P2, 1250, 1500, 50, 252},
    {TEXT_1_P1, 1500, 1750, 50, 252},
    {TEXT_1_P2, 1750, 2000, 50, 252},

    {TEXT_1_P1, 2000, 2250, 50, 252},
    {TEXT_1_P2, 2250, 2500, 50, 252},
    {TEXT_1_P1, 2500, 2750, 50, 252},
    {TEXT_1_P2, 2750, 3000, 50, 252},

    {TEXT_1_P1, 3000, 3250, 50, 252},
    {TEXT_1_P2, 3250, 3500, 50, 252},
    {TEXT_1_P1, 3500, 3750, 50, 252},
    {TEXT_1_P2, 3750, 4000, 50, 252},
};
...
sequence_commands_st sequence_2_A[] = {
    {TEXT_2_A1, 0,    2000,  50, 252},
    {TEXT_2_A2, 1000, 3000,  50, 252},
    {TEXT_2_A3, 2000, 4000,  50, 252},
    {TEXT_2_A4, 3000, 5000,  50, 252},
    {TEXT_2_A5, 4000, 6000,  50, 252},
    {TEXT_2_A6, 6000, 8000,  50, 252},
    {TEXT_2_A7, 7000, 9000,  50, 252},
    {TEXT_2_A8, 8000, 10000, 50, 252},
    {TEXT_2_A9, 9000, 11000, 50, 252},
};
uint16_t sequence_2_A_size = sizeof(sequence_2_A) / sizeof(sequence_2_A[0]);

sequence_commands_st sequence_2_B[] = {
    {TEXT_2_B1, 0,    2000,  50, 252},
    {TEXT_2_B2, 1000, 3000,  50, 252},
    {TEXT_2_B3, 2000, 4000,  50, 252},
    {TEXT_2_B4, 3000, 5000,  50, 252},
    {TEXT_2_B5, 4000, 6000,  50, 252},
    {TEXT_2_B6, 6000, 8000,  50, 252},
    {TEXT_2_B7, 7000, 9000,  50, 252},
    {TEXT_2_B8, 8000, 10000, 50, 252},
    {TEXT_2_B9, 9000, 11000, 50, 252},
};
uint16_t sequence_2_B_size = sizeof(sequence_2_B) / sizeof(sequence_2_B[0]);

sequence_commands_st sequence_2_C[] = {
    {TEXT_2_C1, 0,     500, 50, 252},
    {TEXT_2_C2,  500, 1000, 50, 252},
    {TEXT_2_C3, 1000, 1500, 50, 252},
    {TEXT_2_C4, 2000, 2500, 50, 252},

    {TEXT_2_C1, 3000, 3500, 50, 252},
    {TEXT_2_C2, 3500, 4000, 50, 252},
    {TEXT_2_C3, 4000, 4500, 50, 252},
    {TEXT_2_C4, 4500, 5000, 50, 252},
};
uint16_t sequence_2_C_size = sizeof(sequence_2_C) / sizeof(sequence_2_C[0]);

sequence_commands_st sequence_2_D[] = {
    {TEXT_2_D1, 0,     500, 50, 252},
    {TEXT_2_D2, 1000, 1500, 50, 252},
    {TEXT_2_D3, 1500, 2000, 50, 252},
    {TEXT_2_D4, 2500, 3000, 50, 252},

    {TEXT_2_D1, 3000, 3500, 50, 252},
    {TEXT_2_D2, 4000, 4500, 50, 252},
    {TEXT_2_D3, 4500, 5000, 50, 252},
    {TEXT_2_D4, 5500, 6000, 50, 252},
};
uint16_t sequence_2_D_size = sizeof(sequence_2_D) / sizeof(sequence_2_D[0]);

sequence_commands_st sequence_2_E[] = {
    {TEXT_2_E1,     0,  2000, 50, 252},
    {TEXT_2_E2,  1000,  3000, 50, 252},
    {TEXT_2_E3,  2000,  4000, 50, 252},
    {TEXT_2_E4,  3000,  5000, 50, 252},
    {TEXT_2_E5,  4000,  6000, 50, 252},
    {TEXT_2_E1,  6000,  7000, 50, 252},
    {TEXT_2_E2,  6500,  7500, 50, 252},
    {TEXT_2_E3,  7000,  8000, 50, 252},
    {TEXT_2_E4,  8000,  9000, 50, 252},
    {TEXT_2_E5,  9000, 10000, 50, 252},
    {TEXT_2_E1, 10000, 10500, 50, 252},
    {TEXT_2_E2, 10500, 11000, 50, 252},
    {TEXT_2_E3, 10000, 11500, 50, 252},
    {TEXT_2_E4, 11500, 12000, 50, 252}, // Yeah this is correct
    {TEXT_2_E5, 12000, 12500, 50, 252}, // Yeah this is correct

};
uint16_t sequence_2_E_size = sizeof(sequence_2_E) / sizeof(sequence_2_E[0]);

sequence_commands_st sequence_2_P[] = {
    {TEXT_2_P1, 0,     250, 50, 252},
    {TEXT_2_P1, 500,   750, 50, 252},
    {TEXT_2_P2, 1000, 1250, 50, 252},
    {TEXT_2_P2, 1500, 1750, 50, 252},
    {TEXT_2_P3, 2000, 2250, 50, 252},
    {TEXT_2_P3, 2500, 2750, 50, 252},
    {TEXT_2_P4, 3000, 3250, 50, 252},
    {TEXT_2_P4, 3500, 3750, 50, 252},

    {TEXT_2_P1, 4000, 4250, 50, 252},
    {TEXT_2_P1, 4500, 4750, 50, 252},
    {TEXT_2_P2, 5000, 5250, 50, 252},
    {TEXT_2_P2, 5500, 5750, 50, 252},
    {TEXT_2_P3, 6000, 6250, 50, 252},
    {TEXT_2_P3, 6500, 6750, 50, 252},
    {TEXT_2_P4, 7000, 7250, 50, 252},
    {TEXT_2_P4, 7500, 7750, 50, 252},
};
...
sequence_commands_st sequence_3_A[] = {
    {TEXT_3_A1,  0,    1000, 50, 252},
    {TEXT_3_A1,  1500, 2000, 50, 252},
    {TEXT_3_A2,  2000, 3000, 50, 252},
    {TEXT_3_A2,  3500, 4000, 50, 252},
    {TEXT_3_A3,  4000, 5000, 50, 252},
    {TEXT_3_A3,  5500, 6000, 50, 252},
    {TEXT_3_A4,  6000, 7000, 50, 252},
    {TEXT_3_A4,  7500, 8000, 50, 252},
    {TEXT_3_A5,  8000, 9000, 50, 252},
    {TEXT_3_A5,  9500, 10000, 50, 252},
    {TEXT_3_A6,  10000, 11000, 50, 252},
    {TEXT_3_A6,  11500, 12000, 50, 252},
    {TEXT_3_A7,  12000, 13000, 50, 252},
    {TEXT_3_A7,  13500, 14000, 50, 252},
    {TEXT_3_A8,  14000, 15000, 50, 252},
    {TEXT_3_A8,  15500, 16000, 50, 252},
    {TEXT_3_A9,  16000, 17000, 50, 252},
    {TEXT_3_A9,  17500, 18000, 50, 252},
    {TEXT_3_A10, 18000, 19000, 50, 252},
    {TEXT_3_A10, 19500, 20000, 50, 252},
    {TEXT_3_A11, 20000, 21000, 50, 252},
    {TEXT_3_A11, 21500, 22000, 50, 252},
    {TEXT_3_A12, 22000, 23000, 50, 252},
    {TEXT_3_A12, 23500, 24000, 50, 252},
};
uint16_t sequence_3_A_size = sizeof(sequence_3_A) / sizeof(sequence_3_A[0]);

sequence_commands_st sequence_3_B[] = {
    {TEXT_3_B1, 0,     2000,  50, 252},
    {TEXT_3_B1, 2500,  3000,  50, 252},
    {TEXT_3_B1, 3500,  4000,  50, 252},
    {TEXT_3_B1, 4000,  5000,  50, 252},
    {TEXT_3_B2, 6000,  7000,  50, 252},
    {TEXT_3_B2, 7500,  8000,  50, 252},
    {TEXT_3_B2, 8500,  9000,  50, 252},
    {TEXT_3_B2, 9500,  10000, 50, 252},
    {TEXT_3_B3, 10000, 12000, 50, 252},
    {TEXT_3_B3, 12500, 13000, 50, 252},
    {TEXT_3_B3, 13500, 14000, 50, 252},
    {TEXT_3_B3, 14500, 15000, 50, 252},
};
uint16_t sequence_3_B_size = sizeof(sequence_3_B) / sizeof(sequence_3_B[0]);

sequence_commands_st sequence_3_C[] = {
    {TEXT_3_C1,     0,  500, 50, 252},
    {TEXT_3_C2,   500, 1000, 50, 252},
    {TEXT_3_C3,  1000, 1500, 50, 252},
    {TEXT_3_C4,  1500, 2000, 50, 252},
    {TEXT_3_C5,  2000, 2500, 50, 252},
    {TEXT_3_C6,  2500, 3000, 50, 252},
    {TEXT_3_C7,  3000, 3500, 50, 252},
    {TEXT_3_C8,  3500, 4000, 50, 252},
    {TEXT_3_C9,  4000, 4500, 50, 252},
    {TEXT_3_C10, 4500, 5000, 50, 252},
    {TEXT_3_C11, 5000, 5500, 50, 252},
    {TEXT_3_C12, 5500, 6000, 50, 252},
};
uint16_t sequence_3_C_size = sizeof(sequence_3_C) / sizeof(sequence_3_C[0]);

sequence_commands_st sequence_3_D[] = {
    {TEXT_3_D1, 0,    1500, 50, 252},
    {TEXT_3_D2, 1500, 3000, 50, 252},
    {TEXT_3_D3, 3000, 4500, 50, 252},

    {TEXT_3_D1, 5000, 5500, 50, 252},
    {TEXT_3_D2, 5500, 6000, 50, 252},
    {TEXT_3_D3, 6000, 6500, 50, 252},

    {TEXT_3_D1, 7000, 7500, 50, 252},
    {TEXT_3_D2, 7500, 8000, 50, 252},
    {TEXT_3_D3, 8000, 8500, 50, 252},

    {TEXT_3_D1, 9500,  10000, 50, 252},
    {TEXT_3_D1, 10500, 11000, 50, 252},
    {TEXT_3_D1, 11500, 12000, 50, 252},
    {TEXT_3_D2, 11000, 11500, 50, 252},
    {TEXT_3_D2, 12000, 12500, 50, 252},
    {TEXT_3_D2, 13000, 13500, 50, 252},
    {TEXT_3_D3, 12500, 13000, 50, 252},
    {TEXT_3_D3, 13500, 14000, 50, 252},
    {TEXT_3_D3, 14500, 15000, 50, 252},
};
uint16_t sequence_3_D_size = sizeof(sequence_3_D) / sizeof(sequence_3_D[0]);

sequence_commands_st sequence_3_P[] = {
    {TEXT_3_P1,    0,  250, 50, 252},
    {TEXT_3_P1,  500,  750, 50, 252},
    {TEXT_3_P2, 1000, 1250, 50, 252},
    {TEXT_3_P2, 1500, 1750, 50, 252},
    {TEXT_3_P3, 2000, 2250, 50, 252},
    {TEXT_3_P3, 2500, 2750, 50, 252},
    {TEXT_3_P4, 3000, 3250, 50, 252},
    {TEXT_3_P4, 3500, 3750, 50, 252},
    {TEXT_3_P5, 4000, 4250, 50, 252},
    {TEXT_3_P5, 4500, 4750, 50, 252},
    {TEXT_3_P6, 5000, 5250, 50, 252},
    {TEXT_3_P6, 5500, 5750, 50, 252},
};
...
sequence_commands_st sequence_4_A[] = {
    {TEXT_4_A1,    0, 1000, 50, 252},
    {TEXT_4_A2,  500, 1500, 50, 252},
    {TEXT_4_A3, 1000, 2000, 50, 252},
    {TEXT_4_A4, 1500, 2500, 50, 252},
    {TEXT_4_A5, 2000, 3000, 50, 252},
    {TEXT_4_A6, 2500, 3500, 50, 252},
    {TEXT_4_A7, 3000, 4000, 50, 252},

    {TEXT_4_A1, 3500, 4500, 50, 252},
    {TEXT_4_A2, 4000, 5000, 50, 252},
    {TEXT_4_A3, 4500, 5500, 50, 252},
    {TEXT_4_A4, 5000, 6000, 50, 252},
    {TEXT_4_A5, 5500, 6500, 50, 252},
    {TEXT_4_A6, 6000, 7000, 50, 252},
    {TEXT_4_A7, 6500, 7500, 50, 252},
};
uint16_t sequence_4_A_size = sizeof(sequence_4_A) / sizeof(sequence_4_A[0]);

sequence_commands_st sequence_4_B[] = {
    {TEXT_4_B1,    0,   500,  50, 252},
    {TEXT_4_B2, 1000,  1500,  50, 252},
    {TEXT_4_B3, 2000,  2500,  50, 252},
    {TEXT_4_B4, 3000,  3500,  50, 252},

    {TEXT_4_B1, 4000,  4500,  50, 252},
    {TEXT_4_B2, 5000,  5500,  50, 252},
    {TEXT_4_B3, 6000,  6500,  50, 252},
    {TEXT_4_B4, 7000,  7500,  50, 252},

    {TEXT_4_B1, 8000,  8500,  50, 252},
    {TEXT_4_B2, 9000,  9500,  50, 252},
    {TEXT_4_B3, 10000, 10500, 50, 252},
    {TEXT_4_B4, 11000, 11500, 50, 252},
};
uint16_t sequence_4_B_size = sizeof(sequence_4_B) / sizeof(sequence_4_B[0]);

sequence_commands_st sequence_4_C[] = {
    {TEXT_4_C1,     0,  1000, 50, 252},
    {TEXT_4_C1,  1500,  3000, 50, 252},
    {TEXT_4_C2,  2000,  3000, 50, 252},
    {TEXT_4_C2,  3500,  5000, 50, 252},
    {TEXT_4_C3,  4000,  5000, 50, 252},
    {TEXT_4_C3,  5500,  7000, 50, 252},
    {TEXT_4_C4,  6000,  7000, 50, 252},
    {TEXT_4_C4,  7500,  9000, 50, 252},
    {TEXT_4_C5,  8000,  9000, 50, 252},
    {TEXT_4_C5,  9500, 11000, 50, 252},
    {TEXT_4_C6, 10000, 11000, 50, 252},
    {TEXT_4_C6, 11500, 13000, 50, 252},
    {TEXT_4_C7, 12000, 13000, 50, 252},
    {TEXT_4_C7, 13500, 15000, 50, 252},
};
uint16_t sequence_4_C_size = sizeof(sequence_4_C) / sizeof(sequence_4_C[0]);

sequence_commands_st sequence_4_D[] = {
    {TEXT_4_D1,     0,   500, 50, 252},
    {TEXT_4_D1,  1000,  1500, 50, 252},
    {TEXT_4_D1,  2000,  2500, 50, 252},
    {TEXT_4_D2,  2500,  3000, 50, 252},
    {TEXT_4_D2,  3500,  4000, 50, 252},
    {TEXT_4_D2,  4500,  5000, 50, 252},
    {TEXT_4_D4,  3000,  3500, 50, 252},
    {TEXT_4_D4,  4000,  4500, 50, 252},
    {TEXT_4_D4,  5000,  5500, 50, 252},
    {TEXT_4_D3,  5500,  6000, 50, 252},
    {TEXT_4_D3,  6500,  7000, 50, 252},
    {TEXT_4_D3,  7500,  8000, 50, 252},
    {TEXT_4_D2,  8000,  8500, 50, 252},
    {TEXT_4_D2,  9500, 10000, 50, 252},
    {TEXT_4_D2, 11000, 11500, 50, 252},
    {TEXT_4_D4,  8500,  9000, 50, 252},
    {TEXT_4_D4, 10000, 10500, 50, 252},
    {TEXT_4_D4, 11500, 12000, 50, 252},
    {TEXT_4_D6,  9000,  9500, 50, 252},
    {TEXT_4_D6, 10500, 11000, 50, 252},
    {TEXT_4_D6, 12000, 12500, 50, 252},
    {TEXT_4_D5, 12500, 13000, 50, 252},
    {TEXT_4_D5, 13500, 14000, 50, 252},
    {TEXT_4_D5, 14500, 15000, 50, 252},
    {TEXT_4_D2, 15000, 15500, 50, 252},
    {TEXT_4_D2, 16500, 17000, 50, 252},
    {TEXT_4_D2, 18000, 18500, 50, 252},
    {TEXT_4_D4, 15500, 16000, 50, 252},
    {TEXT_4_D4, 17000, 17500, 50, 252},
    {TEXT_4_D4, 18500, 19000, 50, 252},
    {TEXT_4_D6, 16000, 16500, 50, 252},
    {TEXT_4_D6, 17500, 18000, 50, 252},
    {TEXT_4_D6, 19000, 19500, 50, 252},
    {TEXT_4_D7, 19500, 20000, 50, 252},
    {TEXT_4_D7, 20500, 21000, 50, 252},
    {TEXT_4_D7, 21500, 22000, 50, 252},
};
uint16_t sequence_4_D_size = sizeof(sequence_4_D) / sizeof(sequence_4_D[0]);

sequence_commands_st sequence_4_E[] = {
    {TEXT_4_E1,  0,     1000, 50, 252},
    {TEXT_4_E2,  1000,  2000, 50, 252},
    {TEXT_4_E3,  2000,  2500, 50, 252},
    {TEXT_4_E3,  3000,  3500, 50, 252},
    {TEXT_4_E4,  3500,  4500, 50, 252},
    {TEXT_4_E5,  4500,  5500, 50, 252},
    {TEXT_4_E6,  5500,  6000, 50, 252},
    {TEXT_4_E6,  6500,  7000, 50, 252},
    {TEXT_4_E7,  7000,  8000, 50, 252},
    {TEXT_4_E8,  8000,  9000, 50, 252},
    {TEXT_4_E9,  9000,  9500, 50, 252},
    {TEXT_4_E9, 10000, 10500, 50, 252},
};
uint16_t sequence_4_E_size = sizeof(sequence_4_E) / sizeof(sequence_4_E[0]);

sequence_commands_st sequence_4_P[] = {
    {TEXT_4_P1,    0,  250, 50, 252},
    {TEXT_4_P1,  500,  750, 50, 252},
    {TEXT_4_P2, 1000, 1250, 50, 252},
    {TEXT_4_P2, 1500, 1750, 50, 252},
    {TEXT_4_P3, 2000, 2250, 50, 252},
    {TEXT_4_P3, 2500, 2750, 50, 252},

    {TEXT_4_P1, 3000, 3250, 50, 252},
    {TEXT_4_P1, 3500, 3750, 50, 252},
    {TEXT_4_P2, 4000, 4250, 50, 252},
    {TEXT_4_P2, 4500, 4750, 50, 252},
    {TEXT_4_P3, 5000, 5250, 50, 252},
    {TEXT_4_P3, 5500, 5750, 50, 252},

    {TEXT_4_P1, 6000, 6250, 50, 252},
    {TEXT_4_P1, 6500, 6750, 50, 252},
    {TEXT_4_P2, 7000, 7250, 50, 252},
    {TEXT_4_P2, 7500, 7750, 50, 252},
    {TEXT_4_P3, 8000, 8250, 50, 252},
    {TEXT_4_P3, 8500, 8750, 50, 252},
};
...
void loop_sequence(uint8_t debug_info){
    ...
    const unsigned long TIMEOUT_VALUE  = 300000UL; // 5 min
