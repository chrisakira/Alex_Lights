...
sequence_commands_st sequence_1_A[] = {
    {TEXT_1_A1, 0,    3000, 0, 250},
    {TEXT_1_A2, 2000, 4000, 0, 250},
    {TEXT_1_A3, 3000, 6000, 0, 250},
    {TEXT_1_A4, 5000, 7000, 0, 250},
    {TEXT_1_A5, 6000, 9000, 0, 250},
};
uint16_t sequence_1_A_size = sizeof(sequence_1_A) / sizeof(sequence_1_A[0]);

sequence_commands_st sequence_1_B[] = {
    {TEXT_1_B1, 0,    500,  0, 250},
    {TEXT_1_B1, 1000, 1500, 0, 250},
    {TEXT_1_B1, 2000, 3000, 0, 250},
    // {TEXT_1_B2, 1500, 2000, 0, 250},
    // {TEXT_1_B2, 2500, 3500, 0, 250},
    {TEXT_1_B3, 3000, 3500, 0, 250},
    {TEXT_1_B3, 4000, 4500, 0, 250},
    {TEXT_1_B3, 5000, 6000, 0, 250},
    // {TEXT_1_B4, 4500, 5000, 0, 250},
    // {TEXT_1_B4, 5500, 6500, 0, 250},
    {TEXT_1_B5, 6000, 6500, 0, 250},
    {TEXT_1_B5, 7000, 7500, 0, 250},
    // {TEXT_1_B6, 6500, 7000, 0, 250},
    // {TEXT_1_B6, 7500, 8500, 0, 250},
    {TEXT_1_B5, 8000, 9000, 0, 250},
};
uint16_t sequence_1_B_size = sizeof(sequence_1_B) / sizeof(sequence_1_B[0]);

sequence_commands_st sequence_1_C[] = {
    {TEXT_1_C1, 0,    2000, 0, 250},
    {TEXT_1_C2, 1000, 3000, 0, 250},
    {TEXT_1_C3, 2000, 4000, 0, 250},
    {TEXT_1_C4, 3000, 5000, 0, 250},
    {TEXT_1_C5, 4000, 6000, 0, 250},
    {TEXT_1_C1, 7000, 9000, 0, 250},
    {TEXT_1_C2, 8000, 10000, 0, 250},
    {TEXT_1_C3, 9000, 11000, 0, 250},
    {TEXT_1_C4, 10000, 12000, 0, 250},
    {TEXT_1_C5, 11000, 13000, 0, 250},
};
uint16_t sequence_1_C_size = sizeof(sequence_1_C) / sizeof(sequence_1_C[0]);

sequence_commands_st sequence_1_D[] = {
    {TEXT_1_D1, 0,    2000, 0, 250},
    // {TEXT_1_D2, 1000, 4000, 0, 250},
    // {TEXT_1_D3, 3000, 5000, 0, 250},
    {TEXT_1_D4, 4000, 6000, 0, 250},
    // {TEXT_1_D5, 5000, 8000, 0, 250},
    // {TEXT_1_D6, 7000, 9000, 0, 250},
    {TEXT_1_D7, 8000, 10000, 0, 250},
    // {TEXT_1_D8, 9000, 11000, 0, 250},
};
...
sequence_commands_st sequence_2_A[] = {
    {TEXT_2_A1, 0,    2000,  0, 250},
    {TEXT_2_A2, 1000, 3000,  0, 250},
    {TEXT_2_A3, 2000, 4000,  0, 250},
    {TEXT_2_A4, 3000, 5000,  0, 250},
    {TEXT_2_A5, 4000, 6000,  0, 250},
    {TEXT_2_A6, 6000, 8000,  0, 250},
    {TEXT_2_A7, 7000, 9000,  0, 250},
    {TEXT_2_A8, 8000, 10000, 0, 250},
    {TEXT_2_A9, 9000, 11000, 0, 250},
};
uint16_t sequence_2_A_size = sizeof(sequence_2_A) / sizeof(sequence_2_A[0]);

sequence_commands_st sequence_2_B[] = {
    {TEXT_2_B1, 0,    2000,  0, 250},
    {TEXT_2_B2, 1000, 3000,  0, 250},
    {TEXT_2_B3, 2000, 4000,  0, 250},
    {TEXT_2_B4, 3000, 5000,  0, 250},
    {TEXT_2_B5, 4000, 6000,  0, 250},
    {TEXT_2_B6, 6000, 8000,  0, 250},
    {TEXT_2_B7, 7000, 9000,  0, 250},
    {TEXT_2_B8, 8000, 10000, 0, 250},
    {TEXT_2_B9, 9000, 11000, 0, 250},
};
...
sequence_commands_st sequence_2_D[] = {
    ...
    {TEXT_2_D2, 1000, 1500, 0, 250},
    {TEXT_2_D3, 1500, 2000, 0, 250},
    {TEXT_2_D4, 2500, 3000, 0, 250},

    {TEXT_2_D1, 3000, 3500, 0, 250},
    {TEXT_2_D2, 4000, 4500, 0, 250},
    {TEXT_2_D3, 4500, 5000, 0, 250},
    {TEXT_2_D4, 5500, 6000, 0, 250},
};
uint16_t sequence_2_D_size = sizeof(sequence_2_D) / sizeof(sequence_2_D[0]);

sequence_commands_st sequence_2_E[] = {
    {TEXT_2_E1,     0,  2000, 0, 250},
    {TEXT_2_E2,  1000,  3000, 0, 250},
    {TEXT_2_E3,  2000,  4000, 0, 250},
    {TEXT_2_E4,  3000,  5000, 0, 250},
    {TEXT_2_E5,  4000,  6000, 0, 250},
    {TEXT_2_E1,  6000,  7000, 0, 250},
    {TEXT_2_E2,  6500,  7500, 0, 250},
    {TEXT_2_E3,  7000,  8000, 0, 250},
    {TEXT_2_E4,  8000,  9000, 0, 250},
    {TEXT_2_E5,  9000, 10000, 0, 250},
    {TEXT_2_E1, 10000, 10500, 0, 250},
    {TEXT_2_E2, 10500, 11000, 0, 250},
    {TEXT_2_E3, 10000, 11500, 0, 250},
    {TEXT_2_E4, 11500, 12000, 0, 250}, // Yeah this is correct
    {TEXT_2_E5, 12000, 12500, 0, 250}, // Yeah this is correct
...
sequence_commands_st sequence_3_A[] = {
    ...
    {TEXT_3_A3,  4000, 5000, 0, 250},
    {TEXT_3_A3,  5500, 6000, 0, 250},
    {TEXT_3_A4,  6000, 7000, 0, 250},
...
sequence_commands_st sequence_3_B[] = {
    ...
    {TEXT_3_B1, 4000,  5000,  0, 250},
    {TEXT_3_B2, 6000,  7000,  0, 250},
...
sequence_commands_st sequence_3_C[] = {
    ...
    {TEXT_3_C5,  2000, 2500, 0, 250},
    {TEXT_3_C6,  2500, 3000, 0, 250},
    {TEXT_3_C7,  3000, 3500, 0, 250},
    {TEXT_3_C8,  3500, 4000, 0, 250},
    {TEXT_3_C9,  4000, 4500, 0, 250},
    {TEXT_3_C10, 4500, 5000, 0, 250},
    {TEXT_3_C11, 5000, 5500, 0, 250},
    {TEXT_3_C12, 5500, 6000, 0, 250},
};
...
sequence_commands_st sequence_4_B[] = {
    ...
    {TEXT_4_B2, 1000,  1500,  0, 250},
    {TEXT_4_B3, 2000,  2500,  0, 250},
    {TEXT_4_B4, 3000,  3500,  0, 250},

    {TEXT_4_B1, 4000,  4500,  0, 250},
    {TEXT_4_B2, 5000,  5500,  0, 250},
    {TEXT_4_B3, 6000,  6500,  0, 250},
    {TEXT_4_B4, 7000,  7500,  0, 250},

    {TEXT_4_B1, 8000,  8500,  0, 250},
    {TEXT_4_B2, 9000,  9500,  0, 250},
    {TEXT_4_B3, 10000, 10500, 0, 250},
    {TEXT_4_B4, 11000, 11500, 0, 250},
};
...
sequence_commands_st sequence_4_C[] = {
    ...
    {TEXT_4_C1,  1500,  3000, 0, 250},
    {TEXT_4_C2,  2000,  3000, 0, 250},
    {TEXT_4_C2,  3500,  5000, 0, 250},
    {TEXT_4_C3,  4000,  5000, 0, 250},
    {TEXT_4_C3,  5500,  7000, 0, 250},
    {TEXT_4_C4,  6000,  7000, 0, 250},
    {TEXT_4_C4,  7500,  9000, 0, 250},
    {TEXT_4_C5,  8000,  9000, 0, 250},
    {TEXT_4_C5,  9500, 11000, 0, 250},
    {TEXT_4_C6, 10000, 11000, 0, 250},
    {TEXT_4_C6, 11500, 13000, 0, 250},
    {TEXT_4_C7, 12000, 13000, 0, 250},
    {TEXT_4_C7, 13500, 15000, 0, 250},
};
