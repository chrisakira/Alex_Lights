...
// This sketch is intended to run only on Arduino Mega (ATmega2560/ATmega1280).
// Prevent accidental compilation for other boards.
#if !defined(__AVR_ATmega2560__) && !defined(__AVR_ATmega1280__) && !defined(ARDUINO_AVR_MEGA2560)
#error "This sketch is intended to run on an Arduino Mega (ATmega2560/ATmega1280). Aborting compile."
#endif
